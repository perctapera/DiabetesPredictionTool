...
float sugar = rand.nextFloat();



/*if (urinee ==1 && thirstyy == 1 && hungryy == 1 && tirednesss ==1 && visionn == 1){
	sugar = 1;}

else if (urinee ==0&& thirstyy == 0&& hungryy == 0 && tirednesss ==0 && visionn == 0){
	sugar = 0.5;}

else if (urinee ==1 && thirstyy == 0 && hungryy == 1 && tirednesss ==0 && visionn == 1){
	sugar = 0.6;}

else if (urinee ==1 && thirstyy == 1 && hungryy == 1 && tirednesss ==1 && visionn == 1){
	sugar = 1;}

else if (urinee ==1 && thirstyy == 1 && hungryy == 1 && tirednesss ==0 && visionn == 0){
	sugar = 0.9;}

else if (urinee ==1 && thirstyy == 0 && hungryy == 0 && tirednesss ==1 && visionn == 0){
	sugar = 1;}*/
...
User user = (User) session.getAttribute("User");
 ...
 int user_id =user.getId();
		...
		try {
			...
			ps = con.prepareStatement("INSERT INTO profile ( fullname, surname, sex, weight, bmi, age, iffp, bp, dpf, sugar, fk_user, height) VALUES ( ?, ?, ?, ?, ?, ?, ?, ?, ?, ?,?, ?)");
			...
			ps.setInt(12, Integer.parseInt(height));
